                    ...
                    switch (input1) {
                        ...
                        case 'C':   //Compute Total Costs for all camps
                            ...
                            for (int i = 0; i < summerCampList.size(); i++) {
                                SummerCamp cost = (SummerCamp) summerCampList.get(i);
                                cost.computeTotalCosts();
                            }
                        ...
                        case 'D':   //Search for SummerCamp
                            ...
                            for (int i = 0; i < summerCampList.size(); i++) {
                                SummerCamp search = (SummerCamp) summerCampList.get(i);
                                if (search.getCampTitle().equals(inputInfo)) {
                                    operation = true;
                                }
                            }
                            if (operation == true)
                        ...
                        case 'L':   //List SummerCamps
                            ...
                            SummerCamp camp;
                            for (int i = 0; i < summerCampList.size(); i++) {
                                camp = (SummerCamp) summerCampList.get(i);
